...
2. In the constructor __init__(), define all the layers as class attributes, like nn.Linear and nn.Conv2d 
3. In the forward(), define the connectivity of the network. 
'''
...
# Result: 10 epoches training, Accuracy 78.30% 
best_model = model
